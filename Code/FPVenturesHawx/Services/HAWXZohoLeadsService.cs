...
using FPVenturesHawx.Shared;
using Newtonsoft.Json;
using RestSharp;
using System.Collections.Generic;
using System.Linq;

namespace FPVenturesHawx.Services
{
	public class HAWXZohoLeadsService : IHAWXZohoLeadsService
	{
		...
		public List<Record> DuplicateZohoHAWXLeads(List<Data> zohoRecords)
		{
			...
			HawxZohoLeadsModel zohoLeadsModelResponse = new();
			...
			foreach (var batch in batches)
			{
				...
				{
					criteriaString += string.Format(SeacrchCriteria, fields.Email);
