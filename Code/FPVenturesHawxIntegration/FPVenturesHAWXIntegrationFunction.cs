...
{
	public class FPVenturesHAWXIntegrationFunction
    {
		readonly IHAWXZohoLeadsService _hawxZohoLeadsService;
		readonly IZohoLeadsService _zohoLeadsService;
		const string AzureFunctionName = "FPVenturesHAWXIntegrationFunction";

		public FPVenturesHAWXIntegrationFunction(IHAWXZohoLeadsService hawxZohoLeadsService, IZohoLeadsService zohoLeadsService)
		{
