...
namespace FPVenturesFive9InventoryDisposition.Services
{
    public class ZohoService : IZohoService
	{
		...
		public ZohoService(Five9ZohoInventoryConfigurationSettings five9ZohoInventoryConfigurationSettings)
		{
		...
		public List<CallDispositionRecordModel> DuplicateZohoDispositions(List<Five9Model> five9Models)
		{
			...
			foreach (var batch in batches)
			{
				...
				var client = new RestClient(_five9ZohoInventoryConfigurationSettings.ZohoBaseUrl + string.Format(_five9ZohoInventoryConfigurationSettings.ZohoCheckDuplicateDispositionsPath, criteriaString))
				{
					Timeout = -1
				};
		...
		public (List<Datum> successModels, List<ZohoCallDispositionErrorModel> errorModels) PostZohoDispositions(CallDispositionModel callDispositionModel)
		{
			...
			var client = new RestClient(_five9ZohoInventoryConfigurationSettings.ZohoBaseUrl + _five9ZohoInventoryConfigurationSettings.ZohoAddDispositionsPath)
			{
				Timeout = -1
			};
		...
		{
			var client = new RestClient(string.Format(_five9ZohoInventoryConfigurationSettings.ZohoAccessTokenFromRefreshTokenPath, "1000.53379e5113b42493099a326e6a0cddc9.99b05e07e74a28c86d08337febd12665", "1000.KGAQ5OHG3RREM70F468UA2MI7NXTCK", "16a37f8f68fb2bfe6a7eb4fa88177184a40c9adbb5"))
			{
				Timeout = -1
			};
			var request = new RestRequest(Method.POST);
